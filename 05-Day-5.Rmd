...
```{r figs1, fig.cap='Basis Data Spasial',echo=FALSE, message=FALSE, warning=FALSE, out.width='50%', fig.asp=.75, fig.align='center'}
...
```{r figs2, fig.cap='Abstraksi dunia nyata',echo=FALSE, message=FALSE, warning=FALSE, out.width='50%', fig.asp=.75, fig.align='center'}
knitr::include_graphics("img/abstraksi.png")
```
...
```{r figs3, fig.cap='Tipe data',echo=FALSE, message=FALSE, warning=FALSE, out.width='50%', fig.asp=.75, fig.align='center'}
